...
/**
 * \typedef PARETO_REAL
 * \brief Floating point representation of the 'real' parameter for boost::pareto
 *
 ...
 */
typedef float PARETO_REAL;
/**
 * \typedef PARETO_LOCATION
 * \brief Floating point representation of the 'location' parameter for boost::pareto
 *
 * More information can be found here: http://www.boost.org/doc/libs/1_54_0/libs/math/doc/html/math_toolkit/dist_ref/dists/pareto.html
 */
typedef float PARETO_LOCATION;
